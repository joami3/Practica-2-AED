...
caudal<-ggplot(ice.river.df)+geom_line(aes(x=time,y=flow.vat,colour = "Jokulsa Eystri"))+geom_line(aes(x=time,colour ="Vatnsdalsa"))+scale_colour_manual(values = c("Vatnsdalsa" = "blue", "Jokulsa Eystri" = "red"))+labs(title="Caudales de los rios islandeses Vatnsdalsa (azul) y Jokulsa Eystri(azul)",y="Caudal",x="Años")
caudal
